...
def merge_csv_files(output_directory: str, output_file_path: str):
    """
    A helper function that merges .csv files generated by worker nodes.
    ...
    file_paths = [os.path.join(output_directory, f) for f in os.listdir(output_directory) if f.endswith('.csv')]
